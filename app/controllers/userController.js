                    ...
                    if (err) {
                        ...
                        newUser.save((err, newUser) => {
                            if (err) {
                                ...
                                mailerLib.sendEmail('"Track My Bugs welcome mail" <support@tmb.com>',
                                    newUserObj.email, 'Welcome to Track My Bugs', 'Hello, Nice to see you onboard!',
                                    `<b>Start creating and tracking software bugs! ${newUserObj.firstName}</b>`)
                                resolve(newUserObj)
                            }
                        })
                    } else {
